...
class PlanningWorker:
    ...
    async def run(self, task: str) -> dict:
        ...
        system = (
            "You are a Planning Agent specializing in structured reasoning and summarization.\n"
        ...
        for turn in range(6):
            ...
            if calls:
                ...
                return {"agent": "planning_agent", "answer": answer, "usage": usage_data, "tools_used": list(tools_used)}

        await close_all(connections)
        return {"agent": "planning_agent", "answer": content, "usage": usage_data, "tools_used": list(tools_used)}
