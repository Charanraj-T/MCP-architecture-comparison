...
- [Experiment 2: Real MCP Benchmark](experiment2_mcp_benchmark/README.md) — real npx/uvx MCP servers (filesystem, git, fetch, memory, SQLite, sequential-thinking) with Centralized (@1mcp/agent), Federated (Bifrost Code Mode), and Multi-Agent architectures
...
pip install bifrost-ai  # for federated architecture (experiment2)
```
