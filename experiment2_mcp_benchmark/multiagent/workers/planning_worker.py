    ...
    async def run(self, task: str) -> dict:
        ...
        for turn in range(6):
            ...
            if calls:
                ...
                await close_all(connections)
                return {"agent": "planning_agent", "answer": answer, "usage": usage_data, "tools_used": list(tools_used), "mcps_activated": mcps_count, "tool_schema_tokens": tool_schema_tokens, "tools_exposed": tools_exposed}

        await close_all(connections)
        return {"agent": "planning_agent", "answer": content, "usage": usage_data, "tools_used": list(tools_used), "mcps_activated": mcps_count, "tool_schema_tokens": tool_schema_tokens, "tools_exposed": tools_exposed}
